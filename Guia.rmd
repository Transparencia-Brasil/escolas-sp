...
O código 355030 identifica o munícipio de São Paulo e pode ser alterado para manter qualquer outro arquivo desejado.
...
Enquanto há `r nrows(jan_compilado)` linhas no arquivo compilado para janeiro, no arquivo de consulta há `r nrows(jan_consulta)` linhas. Ou seja, aparentemente não há nenhuma entrada faltante.
